...
mobile: MethodMobile, 
browser: opcion == '1' ? ['zenon-md', 'Edge', '2.0.0'] : methodCodeQR ? ['zenon-md', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log(chalk.bold.yellowBright(lenguajeGB['smsConexionGataNina-Li/GataBot-MD']()))
