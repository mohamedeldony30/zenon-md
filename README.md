<p align="center"> 
<a href="https://github.com/GataNina-Li"><img src="http://readme-typing-svg.herokuapp.com?font=mono&size=17&duration=4000&color=F7B11B&center=falso&vCenter=falso&lines=zenon-md++%F0%9F%90%88;Gracias+por+visitar+este+repositorio.+%F0%9F%92%96" height="90px"></a> 
</p>
 
<p align="center">
<img src="https://i.imgur.com/kd8sus3.jpeg" alt="zenon-md" width="800"/>
...
<p align="center">
<a href="#"><img title="zenon-md" src="https://img.shields.io/badge/SI TE AGRADA EL REPOSITORIO APOYAME CON UNA 🌟 ¡GRACIAS! -red?colorA=%255ff0000&colorB=%23017e40&style=for-the-badge"></a> 
<img src="https://i.pinimg.com/originals/d4/3c/90/d43c902873d4db8c85974dfd0798030b.gif" height="28px">
</p>  

<p align="center">
<a href="#"><img title="zenon-md" src="https://img.shields.io/badge/LEA TODO EL README-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge"></a> 
<a href="#"><img title="zenon-md" src="https://img.shields.io/badge/COMPATIBLE CON LA VERSIÓN MULTI DISPOSITIVOS DE WHATSAPP-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge"></a>
</p>
...
[![YouTube](https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/@T_O_Y_S)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/f0.0n1)
[![PayPal](https://img.shields.io/badge/PayPal-00457C?style=for-the-badge&logo=paypal&logoColor=white)](https://paypal.me/mohamedeldony3)
</div>
...
```
```bash
git clone https://github.com/GataNina-Li/GataBot-MD && cd zenon-md
```
```bash
...
### [`zenon-md ~ Archivos`](https://github.com/GataNina-Li/GataBot-MD/archive/refs/heads/master.zip)
...
```
```bash
cd storage/downloads/zenon-md-master/zenon-md-master 
```
```bash
yarn install
```
...
> **Note** Guardar los archivos en la ubicación: storage/downloads/zenon-md-master/zenon-md-master   
----
### 🚀 USAR GATABOT 24/7 EN TERMUX 
> Ejecutar estos comandos dentro de la carpeta zenon-md
```bash
...
> **Warning** deten el bot, haz click en el símbolo (ctrl) [default=z] usar la letra "z" + "ENTER" hasta que salga algo verdes similar a : zenon-md $
...
----
### 😼 ACTUALIZAR GATABOT
> **Note** Comandos para actualizar zenon-md de forma automática
```bash
...
- [x] Configuración <details><summary>Importar Repositorio - zenon-md</summary><img src="https://i.imgur.com/GQyRnMf.jpg"></details>
-----
### 📦⛏️ BOXMINE HOST 
...
> Tutorial para activar **zenon-md** en un servidor reconocido y para todos.
...
- [x] **Configuración** <details><summary>**Ajustes del Servidor - zenon-md**</summary><img src="https://i.imgur.com/tD3NQSR.jpeg"></details>
----
### 🔵 CAFIREXOS 
...
- [x] **Configuración** <details><summary>**Ajustes del Servidor - zenon-md**</summary><img src="https://i.imgur.com/VPvoE5k.jpeg"></details>
----
...
- [x] **Configuración** <details><summary>**Ajustes del Servidor - zenon-md**</summary><img src="https://i.imgur.com/Ly0MffH.jpeg"></details>
-----
### 🟢 INFINITY-HOST
> Activar **zenon-md** 24/7 activo en Infinity-Host
...
- [x] **Configuración** <details><summary>**Ajustes del Servidor - zenon-md**</summary><img src="https://qu.ax/cpgf.jpg"></details>
------------------------
...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/GataNina-Li/GataBot-MD&branch=master&name=zenon-md)

------------------
### ☁️ ACTIVAR EN RENDER 
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://dashboard.render.com/blueprint/new?repo=https%3A%2F%2Fgithub.com%2FGataNina-Li%2Fzenon-md) 
...
```bash
git clone https://github.com/GataNina-Li/GataBot-MD && cd zenon-md && npm install && npm update && node .
```
...
<summary><b>¿Dónde puedes solicitar la licencia para ser Distribuidor Autorizado o reseller de GataBot?</b></summary>
  ...
  - Te ofrecemos opciones exclusivas: **[Instagram](https://www.instagram.com/f0.0n1/)**, **[Telegram](https://t.me/SoporteGataBot)**, y **[correo electrónico](centergatabot@gmail.com)**.
</details>
